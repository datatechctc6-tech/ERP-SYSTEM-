    ...
    return (
        <div className="partylist-page h-full w-full bg-[#f0f4f4] flex overflow-hidden">
            <div className="w-full h-full bg-white border-[2px] border-[#004d40] shadow-2xl rounded-lg overflow-hidden flex flex-col">
                ...
                {/* Page Header */}
                <div className="pl-header bg-white border-b border-gray-200 px-4 py-1.5 flex items-center justify-between flex-shrink-0">
                        ...
                        <table className="w-full text-left border-collapse border border-gray-300">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {filteredParties.map((party, index) => (
                                    ...
                                    >
                                        <td className="pl-td px-3 border border-gray-200">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="pl-td-name text-gray-800">{party.name}</span>
                                            </div>
                                        </td>
                                        <td className="pl-td px-3 pl-td-text text-gray-600 border border-gray-200">
                                            <div className="flex items-center gap-2">
                                                <MapPin size={12} className="text-gray-400 pl-icon" />
                                                {party.address}
                                            </div>
                                        </td>
                                        <td className="pl-td px-3 pl-td-text text-gray-600 border border-gray-200">
                ...
                <div className="pl-footer bg-white border-t border-gray-200 px-4 py-2 flex items-center justify-end gap-3 flex-shrink-0">
                    <button
                        onClick={() => navigate('/dashboard/1')}
                        className="pl-footer-btn bg-[#004d40] hover:bg-red-600 text-white rounded-lg flex items-center gap-2 transition-all shadow-lg active:scale-95 group"
                    >
                    ...
                    <button
                        ...
                        className="pl-footer-btn bg-[#004d40] hover:bg-[#00332e] text-white rounded-lg flex items-center gap-2 transition-all shadow-lg active:scale-95 group"
                    >
